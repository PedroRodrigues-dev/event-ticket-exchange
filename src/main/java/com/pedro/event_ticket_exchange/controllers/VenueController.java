...
public class VenueController {
        ...
        @Operation(summary = "Get all venues", description = "Retrieve a paginated list of all venues.", parameters = {
        ...
        @GetMapping
        public Page<Venue> getAllVenues(@Parameter(hidden = true) Pageable pageable) {
