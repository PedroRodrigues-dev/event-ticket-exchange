...
public class EventController {
        ...
        @Operation(summary = "Get all events", description = "Retrieve a paginated list of all events.", parameters = {
        ...
        @GetMapping
        public Page<Event> getAllEvents(@Parameter(hidden = true) Pageable pageable) {
