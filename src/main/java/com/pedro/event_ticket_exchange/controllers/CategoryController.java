...
public class CategoryController {
        ...
        @Operation(summary = "Get all categories", description = "Retrieve a paginated list of all categories.", parameters = {
        ...
        @GetMapping
        public Page<Category> getAllCategories(@Parameter(hidden = true) Pageable pageable) {
